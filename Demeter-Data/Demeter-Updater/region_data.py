...
This will be the format of data used in this project

WARNING: ANY DATA FROM ANY SOURCE SHOULD ABIDE THIS FORMAT
'''
import pymongo

if __name__=='__main__':

    regions = [{'Place': 'An Giang', 'id': 1594446,'place_id': 'VN.AG', 'coordinate':[105.166672, 10.5]}, 
